...
})({"4qOBk":[function(require,module,exports) {
var HMR_HOST = null;var HMR_PORT = 1234;var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";module.bundle.HMR_BUNDLE_ID = "c73c5cd03d67964d7a01af30de0acbc1";/* global HMR_HOST, HMR_PORT, HMR_ENV_HASH */
...
},{}],"1j0QU":[function(require,module,exports) {
...
var _intlTelInputDefault = _parcelHelpers.interopDefault(_intlTelInput);

const phone = document.querySelectorAll('.phone');
const [home, uae1, uae2, emergency] = [...phone];

_intlTelInputDefault(home, {
  // any initialisation options go here
  utilsScript: 'build/js/utils.js',
  separateDialCode: true
});

_intlTelInputDefault(uae1, {
  // any initialisation options go here
  utilsScript: 'build/js/utils.js',
  separateDialCode: true
});

_intlTelInputDefault(uae2, {
  // any initialisation options go here
  utilsScript: 'build/js/utils.js',
  separateDialCode: true
});

_intlTelInputDefault(emergency, {
  // any initialisation options go here
  utilsScript: 'build/js/utils.js',
  separateDialCode: true
}); // PHONE INPUT BUG
...
const inputs = document.querySelectorAll('.form__input'); //Event Handler

prevBtn.addEventListener('click', () => prevNext(-1));
nextBtn.addEventListener('click', () => prevNext(1));
form.addEventListener('keyup', e => showError(e));

function showSlide(currSlide) {
  //Progress bar 
  progressNum[currSlide].style.backgroundColor = '#0217f5';
  progressNum[currSlide].style.color = '#f4f4f5'; //For showing slide

  slides[currentSlide].style.display = 'block'; //For showing buttons
...
function prevNext(n) {
  //Go back to top
  form.scrollIntoView(); //For Previous btn
...
function showError(e) {
  ...
  const errorEl = document.createElement('small'); //For not repeating the small tag
  ...
  if (!input.checkValidity()) {
    ...
    //input.style.border = '1px solid #0217f5';
    //label.style.color = '#0217f5';
  }
}

showSlide(currentSlide);
},{"intl-tel-input/build/css/intlTelInput.css":"2ZwkW","intl-tel-input":"4Tkjj","@parcel/transformer-js/lib/esmodule-helpers.js":"7vnX4"}],"2ZwkW":[function() {},{}],"4Tkjj":[function(require,module,exports) {
/**
 * Exposing intl-tel-input as a component
 */
module.exports = require("./build/js/intlTelInput");

},{"./build/js/intlTelInput":"2PhTg"}],"2PhTg":[function(require,module,exports) {
/*
...
},{}],"7vnX4":[function(require,module,exports) {
"use strict";
...
},{}]},{},["4qOBk","1j0QU"], "1j0QU", "parcelRequire08e8")

//# sourceMappingURL=index.de0acbc1.js.map
